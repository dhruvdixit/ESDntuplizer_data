...
class AliAnalysisTaskNTGJ_rpa : public AliAnalysisTaskEmcal {
private:
...
#undef O
    ...
    void loadMC(AliESDEvent *esd_event, AliAODEvent *aod_event);
...
public:
    AliAnalysisTaskNTGJ_rpa(const char *name = "NTGJ");
    AliAnalysisTaskNTGJ_rpa(const AliAnalysisTaskNTGJ_rpa &);
    AliAnalysisTaskNTGJ_rpa &operator=(const AliAnalysisTaskNTGJ_rpa &);
    ~AliAnalysisTaskNTGJ_rpa(void);
    ...
    ClassDef(AliAnalysisTaskNTGJ_rpa, 1);
